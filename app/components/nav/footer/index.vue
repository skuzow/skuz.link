...
<template>
  <footer class="pt-5 pb-6">
    <nav
      class="mx-auto flex w-full max-w-6xl flex-1 flex-col items-center justify-between gap-y-4 px-4 md:flex-row md:gap-y-0 md:px-8"
    >
      <p class="font-bold">skuz.link / {{ currentYear }}</p>
